...
public class LoginTest extends BaseTest {
    ...
    public void shouldNotAcessWithInvalidData() {
        ...
        Assertions.assertNotNull(loginPage.elementIsPresent(this.webDriver,LoginPage.getIdLoginButton()));
    }
    ...
    public void shouldAcessWithValidData() {
        ...
        Assertions.assertNull(loginPage.elementIsPresent(this.webDriver,LoginPage.getIdLoginButton()));
    }
}
